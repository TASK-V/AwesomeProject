  ...
  render() {
    return (
	     ...
	     <View style={styles.color2}>
    	      ...
    	      <View style={{width:100, heigth:100, backgroundColor:'#E0E0E0', flex:1,flexDirection:'column',alignItems: 'center'}}>
			 ...
			 <TouchableOpacity>
                    <Text style={styles.buttonText}>Edit the Form Details</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity>
                    <Text style={styles.buttonText}>Upload the authorized files</Text>
                </TouchableOpacity>
			</ImageBackground>
			 ...
			 <TouchableOpacity>
                    <Text style={styles.buttonText}>Current Loan Details</Text>
                </TouchableOpacity>
			</ImageBackground>
			  </View>
			 ...
			 <TouchableOpacity>
                    <Text style={styles.buttonText}>Investor Deatails</Text>
                </TouchableOpacity>
			</ImageBackground>
